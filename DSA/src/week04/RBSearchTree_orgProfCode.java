...
public class RBSearchTree_orgProfCode<E extends Comparable<E>> { 
	...
	public RBSearchTree_orgProfCode() {
...
/////////////////////////////////////////////////
	...
	private void insertFixup(Node<E> x) {
		...
		if(x.parent.color == "B") return;
			...
			if(x.parent == x.parent.parent.left) { // 왼
...
///////////////////////////////////////
	public static void main(String[] args) {
		RBSearchTree_orgProfCode<Integer> mybst = new RBSearchTree_orgProfCode<>();
